...
@section('header.navbar.entertainment.movies.blueraymovies.Dhoom');
                ...
                <div id="productMain" class="row">
                  <div class="col-md-6">
                    <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                      <div class="item"> 
                        <img src="{{asset('/img/Dhoom.jpeg')}}" alt="" class="img-fluid" style="padding: 6px;">
                      </div>
                    </div>
                          <small>
    ...
    <div class="ribbon-background"></div>
                  ...
                  <div class="col-md-6">
                    <div class="box" style="border-radius: 4px">
                      <h3 style="padding: 4px" class="text-left">Dhoom</h3>
                      ...
                      <div class="product-price" style="padding: 4px">
                        <span class="offered-price">
                          <strong style="font-size: 22px">₹250</strong>
                        </span>&nbsp;
                        ...
                        <span class="discount-percentage">
                          <strong style="color: #3f9643;font-size: 15px">50% OFF</strong>
                        </span>
                      </div>
                      ...
                      <i class="fa fa-spinner fa-pulse fa-3x fa-fw loading" style="display: none;"></i>
                        <a href="https://www.bargainbasement.in/shopping/buy?product=2y10ovDh4linZyrQhesWjruUOH6xeiWEEJaLCKX3qLTnIvQmfWHIlGgC" 
