...
@section('header.navbar.entertainment.movies.blueraymovies.Dhoom2');
                ...
                <div id="productMain" class="row">
                  <div class="col-md-6">
                    <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                      <div class="item"> 
                        <img src="{{asset('/img/Dhoom2.jpeg')}}" alt="" class="img-fluid" style="padding: 6px;">
                      </div>
                    </div>
                          <small>
    ...
    <div class="ribbon-background"></div>
                  ...
                  <div class="col-md-6">
                    <div class="box" style="border-radius: 4px">
                      <h3 style="padding: 4px" class="text-left">Dhoom 2</h3>
                      ...
                      <div class="product-price" style="padding: 4px">
                        ...
                        <span class="discount-percentage">
                          <strong style="color: #3f9643;font-size: 15px">40% OFF</strong>
                        </span>
                      </div>
                      ...
                      <i class="fa fa-spinner fa-pulse fa-3x fa-fw loading" style="display: none;"></i>
                        <a href="https://www.bargainbasement.in/shopping/buy?product=2y108r8cCASxEMT60fO70MyHpOS2gDJismAdDfHKLV5FNrl1YukrWgFFO" 
