...
@section('header.navbar.entertainment.movies.blueraymovies.BhaagMilkhaBhaag');
...
<div id="all">
                ...
                <div id="productMain" class="row">
                  <div class="col-md-6">
                    <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                      <div class="item"> 
                        <img src="{{asset('/img/BhaagMilkhaBhaag.jpeg')}}" alt="" class="img-fluid" style="padding: 6px;">
                      </div>
                    </div>
                          <small>
    ...
    <div class="ribbon-background"></div>
                  ...
                  <div class="col-md-6">
                    <div class="box" style="border-radius: 4px">
                      <h3 style="padding: 4px" class="text-left">Bhaag Milkha Bhaag</h3>
                      ...
                      <div class="product-price" style="padding: 4px">
                        <span class="offered-price">
                          <strong style="font-size: 22px">₹500</strong>
                        </span>&nbsp;
                        ...
                        <span class="discount-percentage">
                          <strong style="color: #3f9643;font-size: 15px">28% OFF</strong>
                        </span>
                      </div>
                      ...
                      <i class="fa fa-spinner fa-pulse fa-3x fa-fw loading" style="display: none;"></i>
                        <a href="https://www.bargainbasement.in/shopping/buy?product=2y10e0WWJi8mWmRFiQU2JUjTJO92HcsVsCE2p7AzRwjJrwoeBOB2q" 
  ...
  <!-- Other Details Section -->
                  ...
                  <table class="col-lg-9 col-md-9 col-xs-9">
                    <tbody><tr><th style='width:44%;padding: 12px'>GENERAL</th></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Warranty</span></td><td style='padding:12px'>Not applicable</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Shipping Fee</span></td><td style='padding:12px'>Free</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Other Description</span></td><td style='padding:12px'>N/A</td></tr></tbody>
                  </table>
