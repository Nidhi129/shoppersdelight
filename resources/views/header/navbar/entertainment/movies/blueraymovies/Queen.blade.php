...
@section('header.navbar.entertainment.movies.blueraymovies.Queen');
...
<div id="all">
                ...
                <div id="productMain" class="row">
                  <div class="col-md-6">
                    <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                      <div class="item"> 
                        <img src="{{asset('/img/Queen.jpeg')}}" alt="" class="img-fluid" style="padding: 6px;">
                      </div>
                    </div>
                          <small>
    ...
    <div class="ribbon-background"></div>
                  ...
                  <div class="col-md-6">
                    <div class="box" style="border-radius: 4px">
                      <h3 style="padding: 4px" class="text-left">Queen</h3>
                      ...
                      <div class="product-price" style="padding: 4px">
                        ...
                        <span class="discount-percentage">
                          <strong style="color: #3f9643;font-size: 15px">36% OFF</strong>
                        </span>
                      </div>
                      ...
                      <i class="fa fa-spinner fa-pulse fa-3x fa-fw loading" style="display: none;"></i>
                        <a href="https://www.bargainbasement.in/shopping/buy?product=2y10g8CUTp83qTNY1LlHdlgSk7VEXwznlBVcOrRYG6rmRefPXiw0PTjW" 
  ...
  <!-- Product Specification Section -->
                  ...
                  <table class="col-lg-9 col-md-9 col-xs-9">
                    <tbody>
                      <tr><th style='width:44%;padding: 12px'>GENERAL</th></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Language</span></td><td style='padding:12px'>Hindi</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Country</span></td><td style='padding:12px'>India</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Directed By</span></td><td style='padding:12px'>Vikas Bahl</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Written By</span></td><td style='padding:12px'>Anvita Dutt Guptan (dialogue), Kangana Ranaut(additional dialogue)</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Screenplay By</span></td><td style='padding:12px'>Vikas Bahl, Chaitally Parmar, Parveez Shaikh</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Produced By</span></td><td style='padding:12px'>Viacom 18 Motion Pictures, Anurag Kashyap, Vikramaditya Motwane, Madhu Mantena</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Starring</span></td><td style='padding:12px'>Kangana Ranaut, Rajkummar Rao, Lisa Haydon</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Story By</span></td><td style='padding:12px'>Vikas Bahl</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Cinematography</span></td><td style='padding:12px'>Bobby Singh, Siddharth Diwan (additional cinematography)</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Production Company</span></td><td style='padding:12px'>Phantom Films</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Release Date</span></td><td style='padding:12px'>7th March 2014</td></tr><tr><td style='width:44%;padding: 12px'><span style='color:#808080'>Running Time</span></td><td style='padding:12px'>146 minutes</td></tr>
                    </tbody>                  
                  </table>
  <br>
