...
@section('header.navbar.entertainment.movies.blueraymovies.Cocktail');
                ...
                <div id="productMain" class="row">
                  <div class="col-md-6">
                    <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                      <div class="item"> 
                        <img src="{{asset('/img/Cocktail.jpeg')}}" alt="" class="img-fluid" style="padding: 6px;">
                      </div>
                    </div>
                          <small>
    ...
    <div class="ribbon-background"></div>
                  ...
                  <div class="col-md-6">
                    <div class="box" style="border-radius: 4px">
                      <h3 style="padding: 4px" class="text-left">Cocktail</h3>
                      ...
                      <i class="fa fa-spinner fa-pulse fa-3x fa-fw loading" style="display: none;"></i>
                        <a href="https://www.bargainbasement.in/shopping/buy?product=2y10t4lkvtWW2lxq3VeqmKlcuq7bTfytVVV6eWrMrBv3hZDIymM9JPbW" 
