...
@section('header.navbar.entertainment.movies.blueraymovies')
        ...
        <div class="col-lg-12">
          ...
          <nav aria-label="breadcrumb">
            ...
            <div class="box info-bar">
              <div class="row">
                <div class="col-md-12 col-lg-4 products-showing">Showing <strong>{{$blueraydiscs->count()}}</strong> product(s)</div>
              </div>
            </div>

            
            <div class="row products productlist" id="row-products">
             @foreach($blueraydiscs as $blueraydisc)
                ...
                <div class="product">
                  <div class="flip-container">
                    <div class="flipper">
                      ...
                      <div class="front"><a href="{{route('blueraydisc.show', $blueraydisc->slug)}}"><img src="{{asset('/img/blueraydiscs/'.$blueraydisc->slug.'.jpeg')}}" alt="" class="img-fluid" style="padding: 6px"></a></div>
                    </div>
                  ...
                  <div class="text">
                    ...
                    <div class="product-price" style="padding-left:12px;padding-right:8px">
                      <span class="offered-price">
                        <strong style="font-size: 20px">₹{{$blueraydisc->discount_price}}</strong>&nbsp;
                      </span>&nbsp;
                      <span class="original-price">
                        <strong>
                          <del style="color: #c7254e;font-size: 13px">₹{{$blueraydisc->original_price}}</del>
                        </strong>
                      </span>&nbsp;
                    ...
                    <div class="stock-availability" style="padding-left:12px;padding-right:8px">
                      <strong><span style="color: #c7254e"> @if($blueraydisc->quantity < 5) Hurry! Only  {{$blueraydisc->quantity}} left @endif </span></strong>
                    </div>
                    ...
                    <div class="">
                      <p class="buttons">
                        <a href="https://www.bargainbasement.in/product/dil-toh-pagal-hai/2y10E01SgQx23RB4FKmXS1rfrG4xK01LA6Z60STInnxDiV7AKgm/andromeda-e5vH8sD4wJ0qJ0qg7tJ0q" class="btn btn-outline-secondary submit"><i class="fa fa-file-text-o" aria-hidden="true"></i>&nbsp;<small>DETAILS</small></a>
                        <i class="fa fa-spinner fa-pulse fa-3x fa-fw loading" style="display: none;"></i>
                        <a href="https://www.bargainbasement.in/shopping/buy?product=2y10E01SgQx23RB4FKmXS1rfrG4xK01LA6Z60STInnxDiV7AKgm" class="btn btn-primary submit" onclick="transacting(this);"><i class="fa fa-shopping-cart"></i>&nbsp;<small>BUY NOW</small>
                        </a>
                      </p>
                    </div>
                  </div>
