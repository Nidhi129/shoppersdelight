          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              *** PAGES MENU ***
              ...
              <!-- *** PAGES MENU END ***-->
              {{-- <div class="banner"><a href="https://www.bargainbasement.in/shop/entertainment/movies/blu-ray-movies"><img src="/storage/images/banner.jpg" alt="sales 2014" class="img-fluid"></a></div> --}}
            </div>
  ...
  <div id="contact" class="box">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <!-- <ul> -->
          <strong style="color: #4fbfa8">info@bargainbasement.in</strong>
        <!-- </ul> -->
      </div>
      <!-- /.col-sm-4-->
    </div>
